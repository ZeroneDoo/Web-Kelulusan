        ...
        <div class="card mb-4">
            ...
            Impor Data</button>
                ...
                <div class="modal fade z-index 1050" id="modals" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog">
                        <form action="{{ route('importExcelJurusan') }}" method="post" enctype="multipart/form-data">
                            @csrf
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0" style="max-height: 460px; overflow-y: scroll;">
                <thead>
                  <tr class="">
                    ...
                    <th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Diubah</th>
                ...
                <tbody>
                    @foreach ($jurusans as $jurusan)
                        <tr class="">
                        <td>
                            <h6 class="p-3 mb-0 text-sm ">{{ $jurusan->jurusan }}</h6>
                        </td>
                        <td>
                        ...
                        <td class="align-middle">
                            <div class="d-flex justify-content-center p-3 gap-3">
                                <a href="{{ route('edit.jurusan', ['id' => $jurusan->id]) }}" class="text-secondary font-weight-bold text-sm text-decoration-none"
