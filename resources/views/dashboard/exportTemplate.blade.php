...
<body>
    ...
    {{-- <img src="assets/img/kopSurat.png" style="  margin-top:-50px;" alt=""> --}}

        <h5 style="text-align: center;"><u>SURAT KETERANGAN LULUS</u></h5> 
        <div class="content" style="padding-left: 50px; padding-right: 50px">
            <p style="font-size: 14px">Kepala Sekolah SMK Taruna Bhakti Depok selaku Ketua Penyelenggaran Ujian Sekolah Tahun Pelajaran 2022/2023 berdasarkan : </p>
            <ol>
            ...
            <table border="1" style="border-collapse: collapse;">
                ...
                <tr>
                    <td colspan="2" style="padding-left: 13px; font-size: 12px">Muatan Nasional</td>
                    <td></td>
                </tr>
                <!-- Muatan Nasional -->
                <tr>
                    ...
                    <td style="text-align: center;font-size: 12px">90</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding-left: 10px; font-size:12px;"> Bahasa Inggris dan Bahasa Asing Lainnya</td>
                    <td style="text-align: center; font-size:12px;">90</td>
                </tr>

                <!-- Muatan Kewilayahan -->
                <tr>
                    <td colspan="2" style="padding-left: 13px; font-size:12px;">Muatan Kewilayahan</td>
                    <td></td>
                </tr>
                <tr>
                    <td style="text-align: center; font-size:12px;"> 1.</td>
                ...
                <tr>
                    <td style="text-align: center;" rowspan="4; font-size:12px;"> 3.</td>
                    <td style="padding-left: 10px; font-size:12px;"> Muatan Lokal</td>
                    <td style="text-align: center; font-size:12px;">90</td>
                </tr>
                <tr>
                    <td style="padding-left: 10px; font-size:12px;"> </td>
                    <td style="text-align: center; font-size:12px;">90</td>
                </tr>
                <tr>
                    <td style="padding-left: 10px; font-size:12px;"> </td>
                ...
                <tr>
                    <td colspan="2" style="padding-left: 13px; font-size:12px;">Muatan Peminatan Kejuruan</td>
                    <td></td>
                </tr>
                <tr>
                    <td style="text-align: center; font-size:12px;"> 1.</td>
                ...
                <tr>
                    <td style="text-align: center; font-size:12px;"> 2.</td>
                    <td style="padding-left: 10px; font-size:12px;"> Fisika</td>
                    <td style="text-align: center; font-size:12px;">90</td>
                </tr>
                <tr>
                    <td style="text-align: center; font-size:12px;"> 3.</td>
                    <td style="padding-left: 10px; font-size:12px;"> Kimia</td>
                    <td style="text-align: center; font-size:12px;">90</td>
                </tr>
                <tr>
                    <td style="text-align: center; font-size:12px;"> 4.</td>
            ...
            <div class="footer" style="margin-left: 420px;">
                <p style="font-size: 14px">Depok, 5 Mei 2023</p>
                <p style="font-size: 14px">Kepala Sekolah,</p>
                <div class="" style="width: 100%; height: 40px; font-size:14px;"></div>
                <p style="font-size: 14px">Nursidik, ST</p>
